...
namespace MotoRent.Infrastructure.Migrations
{
    ...
    [Migration("20250429014353_users_create")]
    partial class users_create
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MotoRent.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("5da88e70-967b-4737-91b1-dbcc850b5f73"),
                            Email = "admin@motorrent.com",
                            Name = "Administrator",
                            PasswordHash = "$2a$11$W9QbLEfbts8yEsNGX6a8U.DoAcnykyMhXDR6F0smrK0oRgkq5xdGu",
                            Role = 0
                        });
                });
